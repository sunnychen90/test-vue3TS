  ...
  <el-dialog v-model="visible" :title="!dataForm.id ? $t('add') : $t('update')" :close-on-click-modal="false" :close-on-press-escape="false">
    <el-form :model="dataForm" :rules="dataRule" ref="dataFormRef" @keyup.enter="dataFormSubmitHandle()" label-width="120px">
      ...
      <el-form-item prop="parentName" :label="$t('menu.parentName')" class="menu-list">
        <el-popover v-model:visible="menuListVisible" ref="menuListPopover" placement="bottom-start" trigger="click" :width="400" popper-class="popover-pop">
          <template v-slot:reference>
            <el-input v-model="dataForm.parentName" :readonly="true" :placeholder="$t('menu.parentName')" @click="menuListVisible = true">
          ...
          <el-row justify="end">
            <el-button size="small" type="text" @click="menuListVisible = false" style="margin-right: 15px">{{ $t("close") }}</el-button>
          </el-row>
        </el-popover>
      </el-form-item>
      ...
      <el-form-item v-if="dataForm.type === 0" prop="openStyle" :label="$t('menu.openStyle')" size="small">
      ...
      <el-form-item v-if="dataForm.type === 0" prop="icon" :label="$t('menu.icon')" class="icon-list">
        <el-popover v-model:visible="iconListVisible" ref="iconListPopover" placement="top-start" trigger="click" popper-class="popover-pop mod-sys__menu-icon-popover">
          <template v-slot:reference> <el-input v-model="dataForm.icon" :readonly="true" :placeholder="$t('menu.icon')" @click="iconListVisible = true"></el-input></template>
          ...
          <el-row justify="end">
            <el-button size="small" type="text" @click="iconListVisible = false" style="margin-right: 15px">{{ $t("close") }}</el-button>
          </el-row>
        </el-popover>
      </el-form-item>
    </el-form>
