  ...
  <el-dialog v-model="visible" title="创建菜单" :close-on-click-modal="false" :close-on-press-escape="false">
    <el-form :model="dataForm" :rules="dataRule" ref="dataFormRef" label-width="120px">
      <el-form-item prop="parentName" :label="$t('menu.parentName')" class="menu-list">
        <el-popover v-model:visible="menuListVisible" :width="400" placement="bottom-start" trigger="click" popper-class="popover-pop">
      ...
      <el-form-item prop="icon" :label="$t('menu.icon')" class="icon-list">
        <el-popover v-model:visible="iconListVisible" placement="bottom-start" popper-class="popover-pop mod-sys__menu-icon-popover" trigger="click">
          ...
          <template v-slot:reference>
            <el-input v-model="dataForm.icon" :readonly="true" :placeholder="$t('menu.icon')" @click="iconListVisible = true"></el-input>
          </template>
          <el-row justify="end">
