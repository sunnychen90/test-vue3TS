...
<template>
  <div id="changeContab">
    <el-button class="language" type="text" @click="switchLang" style="margin-top: 4px">{{ i18n }}</el-button>
    <el-tabs type="border-card">
      <el-tab-pane>
        <template v-slot:label>
          <span>
            <el-icon><calendar /></el-icon> {{ text.Seconds.name }}
          </span>
        </template>
        <div class="tabBody">
          <el-row>
      ...
      <el-tab-pane>
        <template v-slot:label>
          <span>
            <el-icon><calendar /></el-icon> {{ text.Minutes.name }}
          </span>
        </template>
        <div class="tabBody">
          <el-row>
      ...
      <el-tab-pane>
        <template v-slot:label>
          <span>
            <el-icon><calendar /></el-icon> {{ text.Hours.name }}
          </span>
        </template>
        <div class="tabBody">
          <el-row>
      ...
      <el-tab-pane>
        <template v-slot:label>
          <span>
            <el-icon><calendar /></el-icon> {{ text.Day.name }}
          </span>
        </template>
        <div class="tabBody">
          <el-row>
      ...
      <el-tab-pane>
        <template v-slot:label>
          <span>
            <el-icon><calendar /></el-icon> {{ text.Month.name }}
          </span>
        </template>
        <div class="tabBody">
          <el-row>
      ...
      <el-tab-pane>
        <template v-slot:label>
          <span>
            <el-icon><calendar /></el-icon> {{ text.Year.name }}
          </span>
        </template>
        <div class="tabBody">
          <el-row>
...
export default defineComponent({
  ...
  computed: {
    text(): IObject {
      return (Language as IObject)[this.i18n || "zh-CN"];
    },
    secondsText() {
      let seconds = "";
